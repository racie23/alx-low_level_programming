 ...
 * @e_ident: A pointer to an array which contains the ELF magic numbers.
 *
...
/**
 * print_class_data_version - Prints class of an ELF header.
...
/**
 * print_osabi_abi - Print the OS/ABI of an ELF header.
...
/**
 * print_type_entry - Print the type of ELF header.
 * @e_type: ELF type.
 * @e_ident: A pointer to an array which contains the ELF class.
 */
void print_type_entry(unsigned int e_type,unsigned long int e_entry,
